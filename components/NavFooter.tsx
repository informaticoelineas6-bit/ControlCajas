...
export default function NavFooter({ usuario, pageAccess }: Readonly<NavProps>) {
  ...
  return (
    <div className="fixed bottom-0 inset-x-0 z-30 md:hidden bg-[linear-gradient(120deg,_rgba(15,23,42,0.98),_rgba(30,41,59,0.94),_rgba(14,165,233,0.88))] border-b border-white/10 text-white shadow-[0_-20px_60px_-20px_rgba(15,23,42,0.5)] py-2 pb-[max(0.5rem,env(safe-area-inset-bottom))] backdrop-blur-sm">
