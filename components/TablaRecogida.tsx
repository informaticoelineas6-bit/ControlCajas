...
import { COLECCIONES, Recogida, TIPOS_EVENTO, Usuario } from "@/lib/constants";
...
export default function TablaRecogida({
  ...
  return (
    <section className="overflow-hidden rounded-[28px] border border-slate-200/80 bg-white/95 shadow-[0_24px_60px_-34px_rgba(15,23,42,0.35)]">
      <div className="border-b border-slate-200 bg-[linear-gradient(135deg,_rgba(99,102,241,0.1),_rgba(255,255,255,0.96))] px-6 py-5">
                    ...
                    <div className="flex items-start justify-between gap-3">
                      ...
                      {usuario.rol === "informatico" && (
                        <button
                          ...
                          onClick={() => onAjustar?.("Recogida", item._id!)}
                        >
                          Ajustar
                        </button>
                      )}
